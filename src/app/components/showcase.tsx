...
import { fleurDeLeah, greatVibes } from '@/fonts';
...
const Showcase: FC<PropsWithChildren<ShowcaseProps>> = ({
  ...
  return (
    <div className='h-svh flex flex-col gap-5'>
      ...
      <div
        className={`${fleurDeLeah.className} relative text-6xl [text-shadow:2px_2px_2px_#6b6b6b] py-5 text-sky-600 space-y-5`}
      >
        <Flowers />
        ...
        <h1
          className={`${greatVibes.className} text-center`}
          data-aos='zoom-in'
        >
          &
        </h1>
